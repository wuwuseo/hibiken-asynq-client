...
这是一个用于 [hibiken/asynq](https://github.com/hibiken/asynq) Go 任务队列的 PHP 客户端，用于在 PHP 中发送异步任务到 Asynq 队列。客户端，提供 API、错误处理、中间件支持和性能优化。
...
查看 `examples/usage_example.php` 文件获取完整的使用示例，包括所有功能的演示。
